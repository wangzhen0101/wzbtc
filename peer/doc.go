...
function which allows a bclog.Logger to be specified.  For example, logging at
...
(https://godoc.org/github.com/wangzhen0101/wzbtc/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
